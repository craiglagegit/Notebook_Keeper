...
def readStream(handle, names, readTime, scanRate=100):
    ...
    name = name + 'Z'
    filename = f'/scratch/labJackData/Dome_Main_{name}.pkl'
...
parser.add_argument('-h', '--help', action='help', default=argparse.SUPPRESS,
                    help='To run this in the background, use the following syntax: nohup python Dome_Monitor_MainBox_05Sep23.py --end_time 2023-08-17T10:00:00 >& monitor_log_17aug23.txt&')
args = parser.parse_args()
end_time = args.end_time
finish_time = Time(end_time, format='isot')

# Open LabJack T7
handle = ljm.openS("T7", "wifi", "139.229.170.115") 
