...
filename = "/project/cslage/BOT_LSSTCam/eotest/eotest_gain_12680_04nov20.pkl"
...
goodCount = 0
badList = open('/project/cslage/BOT_LSSTCam/eotest/badList_12680.txt', 'w')
goodList = open('/project/cslage/BOT_LSSTCam/eotest/goodList_12680.txt', 'w')
for [EO, name] in [[EO_PTC_gains, 'PTC-Run 12680']]:#, [EO_Fe55_gains, 'Fe55-Run 12643']]:
    ratios = []
    plotCounter += 1
    ...
    plt.ylabel("DM PTC Gains(e-/ADU) (Run 12680); %s Flat Pairs"%num, fontsize = 18)
...
plt.savefig(REPO_DIR+"/plots/PTC_Eotest_Gains_12680_04Nov20.pdf")
badList.close()
goodList.close()
print(goodCount)
```
...
plt.ylabel("EOtest PTC-Run-12673 Gains(e-/ADU); All Flat Pairs", fontsize = 18)
xplot = np.linspace(minGain, maxGain,100)
plt.plot(xplot, xplot, ls = '--', color='blue')
...
plt.text(1.01, n.max(), "Median = %.4f"%np.nanmedian(ratios), fontsize = 18)
plt.text(1.01, 0.9*n.max(), "%d CCDs"%numCCDs, fontsize = 18)
plt.savefig(REPO_DIR+"/plots/Eotest_PTC_Eotest_Fe55_Gains_12673_04Nov20.pdf")
```
...
plt.suptitle("BOT Gains - Run 12680 - 2020-11-04", fontsize=24)
...
plt.savefig(REPO_DIR+'/plots/Gain_Summary_12680_04Nov20.pdf')
...
plt.savefig(REPO_DIR+'/plots/Gain_Histograms_12680_04Nov20.pdf')
```
