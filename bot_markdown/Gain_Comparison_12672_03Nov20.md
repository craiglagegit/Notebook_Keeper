...
num = 'All'
run = '12672'
REPO_DIR = '/project/shared/BOT/rerun/cslage/PTC_LSSTCAM_%s'%run
DATA_DIR = '/project/shared/BOT/'
```

```python
# Get the eotest results
filename = "/project/cslage/BOT_LSSTCam/eotest/eotest_gain_12672_03nov20.pkl"
...
goodCount = 0
badList = open('/project/cslage/BOT_LSSTCam/eotest/badList_12672.txt', 'w')
goodList = open('/project/cslage/BOT_LSSTCam/eotest/goodList_12672.txt', 'w')
for [EO, name] in [[EO_PTC_gains, 'PTC-Run 12672'], [EO_Fe55_gains, 'Fe55-Run 12643']]:
    ratios = []
    plotCounter += 1
    ...
    plt.ylabel("DM PTC Gains(e-/ADU) (Run 12672); %s Flat Pairs"%num, fontsize = 18)
...
plt.savefig(REPO_DIR+"/plots/PTC_Eotest_Gains_12672_03Nov20.pdf")
badList.close()
goodList.close()
print(goodCount)
```
...
plt.text(1.01, n.max(), "Median = %.4f"%np.nanmedian(ratios), fontsize = 18)
plt.text(1.01, 0.9*n.max(), "%d CCDs"%numCCDs, fontsize = 18)
plt.savefig(REPO_DIR+"/plots/Eotest_PTC_Eotest_Fe55_Gains_12672_03Nov20.pdf")
```
...
plt.savefig(REPO_DIR+'/plots/Gain_Summary_12672_03Nov20.pdf')
...
plt.suptitle("BOT Gains - Run 12672 - 2020-11-02", fontsize=24)
plotcounter = 0
...
plt.savefig(REPO_DIR+'/plots/Gain_Histograms_12672_03Nov20.pdf')
```
