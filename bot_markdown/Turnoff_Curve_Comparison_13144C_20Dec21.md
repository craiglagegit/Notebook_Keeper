...
filename = '/project/cslage/BOT_LSSTCam/eotest/turnoff_clump_itl_13144C.txt'
...
```python
pdf = PdfPages("/repo/main/u/cslage/bps_13144C/plots/PTC_Turnoff_Clump_13144C_ITL_20Dec21.pdf")
for ii, [RAFT,SENSOR,amp] in enumerate(badAmps):
    # There are over 100, so let's only plot about 25% of them
