...
```python
linPtcButler = Butler("/repo/main", collections=["u/cslage/bps_13144L"])
```
...
```python
expId=3021120700200
pdf = PdfPages("/repo/main/u/cslage/bps_13144L/plots/Linearity_Results_13144L_Good_03Jan21.pdf")
