...
```python
num = 'All'
REPO_DIR = '/project/shared/BOT/rerun/cslage/PTC_LSSTCAM_12672'
...
filename = "/project/cslage/BOT_LSSTCam/eotest/badList_12672.txt"
...
pdf = PdfPages(REPO_DIR+"/plots/Gain_Differences_GT_5Pct_03Nov20.pdf")
for [RAFT,SENSOR,amp] in badAmps:         
    ...
    filename = "/project/cslage/BOT_LSSTCam/eotest/%s_%s_12672_ptc.fits"%(RAFT,SENSOR)
