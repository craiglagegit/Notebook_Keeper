...
num = 'All'
run = '12673'
REPO_DIR = '/project/shared/BOT/rerun/cslage/PTC_LSSTCAM_%sA'%run
...
goodCount = 0
badList = open('/project/cslage/BOT_LSSTCam/eotest/badList_12673.txt', 'w')
goodList = open('/project/cslage/BOT_LSSTCam/eotest/goodList_12673.txt', 'w')
for [EO, name] in [[EO_PTC_gains, 'PTC-Run 12673']]:#, [EO_Fe55_gains, 'Fe55-Run 12643']]:
        ...
        for DETECTOR in detectors.keys():
            ...
            for i in range(16):
                ...
                if vendor == VENDOR:
                    ...
                    if name == 'PTC-Run 12673' and (ratio < 0.95 or ratio > 1.05):
    ...
    plt.ylabel("DM PTC Gains(e-/ADU) (Run 12673); %s Flat Pairs"%num, fontsize = 18)
...
plt.savefig(REPO_DIR+"/plots/PTC_Eotest_Gains_12673_05Nov20.pdf")
badList.close()
goodList.close()
print(goodCount)
```
...
plt.text(1.01, n.max(), "Median = %.4f"%np.nanmedian(ratios), fontsize = 18)
plt.text(1.01, 0.9*n.max(), "%d CCDs"%numCCDs, fontsize = 18)
plt.savefig(REPO_DIR+"/plots/Eotest_PTC_Eotest_Fe55_Gains_12673_05Nov20.pdf")
```
...
plt.suptitle("BOT Gains - Run 12673 - 2020-11-04", fontsize=24)
...
plt.savefig(REPO_DIR+'/plots/Gain_Summary_12673_05Nov20.pdf')
...
plt.savefig(REPO_DIR+'/plots/Gain_Histograms_12673_05Nov20.pdf')
```
