...
```python
# Get the "badAmps" results.  These are amps from the "clump" of low DM turnoff
filename = '/project/cslage/BOT_LSSTCam/eotest/turnoff_clump_13038.txt'
...
```python
pdf = PdfPages("/repo/main/u/cslage/bps_13038/plots/PTC_Turnoff_Clump_13038_23Nov21.pdf")
for ii, [RAFT,SENSOR,amp] in enumerate(badAmps):
    ...
    filename = "/project/cslage/BOT_LSSTCam/eotest/%s_%s_13038_ptc.fits"%(RAFT,SENSOR)
