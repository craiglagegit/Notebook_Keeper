...
```python
linPtcButler = Butler("/repo/main", collections=["u/cslage/bps_13144J"])
```
...
```python
expId=3021120700200
pdf = PdfPages("/repo/main/u/cslage/bps_13144J/plots/Linearity_Results_13144J_29Dec21.pdf")
...
for i, det in enumerate([55, 74]):
    ...
    for amp in camera[0].getAmplifiers()[0:1]:
        ampName = amp.getName()
