...
filename = '/project/cslage/BOT_LSSTCam/eotest/badList_13144M.txt'
...
```python
# Get the "goodAmps" results.  These are amps where the gains differed by more than 5%
...
```python
thisList = goodAmps[0:5] + badAmps[0:5]
print(len(thisList))
```
...
badList = [['R03', 'S11', 'C00'], ['R20', 'S00', 'C17'], ['R30', 'S00', 'C10'], \
           ['R03', 'S01', 'C10'], ['R41', 'S21', 'C02'], ['R43', 'S22', 'C00']]
```
...
for ii, [RAFT,SENSOR,amp] in enumerate(badList):
    ...
    ax2.set_title("Mean Histograms", fontsize=12)
    ax2.hist(
