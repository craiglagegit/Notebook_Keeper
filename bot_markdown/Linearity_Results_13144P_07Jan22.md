...
```python
linButler = Butler("/repo/main", collections=["u/cslage/calib/13144/linearizer_corrected_20220107"])
```
...
```python tags=[]
expId=3021120700200
pdf = PdfPages("/repo/main/u/cslage/bps_13144P/plots/Linearity_Results_13144P_Corrected_21Jan22.pdf")
