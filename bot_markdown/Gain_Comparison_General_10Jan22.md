...
Initially written 10 Jan 2022 by Craig Lage.
...
runA = "u/plazas/bps_13144Q_2021JAN12.2"
runB = "u/cslage/bps_13144M"
...
plt.xlabel("Gains(e-/ADU) (Run %s)"%runB, fontsize = 18)
plt.ylabel("Gains(e-/ADU) (Run %s)"%runA, fontsize = 18)
...
plt.savefig("/repo/main/%s/plots/Gains_Comparison_Plazas_13Jan22.pdf"%runB)
...
plt.xlabel("A00 (Run %s)"%runB, fontsize = 18)
plt.ylabel("(Run %s)"%runA, fontsize = 18)
...
plt.savefig("/repo/main/%s/plots/A00_Comparison_Plazas_13Jan22.pdf"%runB)
```
...
plt.xlim(minPlot, maxPlot)
plt.ylim(minPlot, maxPlot)
plt.xlabel("Noise (e-) Run %s"%runB, fontsize = 18)
plt.ylabel("Noise (e-) Run %s"%runA, fontsize = 18)
xplot = np.linspace(minPlot, maxPlot,100)
plt.plot(xplot, xplot, ls = '--', color='blue')
slope1 = 1.10
plt.plot(xplot,slope1*xplot, ls = '--', color='red', label = '%.3f'%slope1)
...
plt.text(1.03, 0.9*n.max(), "%d CCDs"%numCCDs, fontsize = 18)
plt.text(1.03, 0.85*n.max(), "%d amps"%len(ratios), fontsize = 18)
plt.savefig("/repo/main/%s/plots/Noise_Comparison_Plazas_13Jan22.pdf"%runB)
```
...
plt.xlim(minPlot, maxPlot)
plt.ylim(minPlot, maxPlot)
plt.xlabel("Turnoff (ADU) Run %s"%runB, fontsize = 18)
plt.ylabel("Turnoff (ADU) Run %s"%runA, fontsize = 18)
xplot = np.linspace(minPlot, maxPlot,100)
plt.plot(xplot, xplot, ls = '--', color='blue')
slope1 = 1.10
plt.plot(xplot,slope1*xplot, ls = '--', color='red', label = '%.3f'%slope1)
...
plt.text(1.03, 0.9*n.max(), "%d CCDs"%numCCDs, fontsize = 18)
plt.text(1.03, 0.85*n.max(), "%d amps"%len(ratios), fontsize = 18)
plt.savefig("/repo/main/%s/plots/Turnoff_Comparison_Plazas_13Jan22.pdf"%runB)
```
