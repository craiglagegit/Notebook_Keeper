...
```python
DATA_DIR = '/project/shared/comCam-CCS/rerun/cslage/ISR_ComCam_2020-11-23'
RAFT = 'R22'
SENSOR ='S22'
DETECTOR = 4
expId1 = 3020112300025
expId2 = 3020112300026
...
mean = np.mean(arr)
std = np.std(arr)
img1 = ax1.imshow(arr, norm=LogNorm(vmin=15000, vmax=25000))
colorbar(img1)
ax1.set_title("PostISRCCD %s %s%s; Mean = %.3f, Std = %.3f"%(RAFT,SENSOR,expId1,mean, std))
arr = exp2.image.array
mean = np.mean(arr)
std = np.std(arr)
img2 = ax2.imshow(arr, norm=LogNorm(vmin=.01, vmax=100))
colorbar(img1)
