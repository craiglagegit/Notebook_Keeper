...
```python
butler = Butler("/repo/main", collections=["LSSTCam/raw/all", "u/cslage/bps_13144N"])
...
for it, amp in enumerate(camera[0].getAmplifiers()):
    ...
    #break
plt.savefig("/repo/main/u/cslage/bps_13144M/plots/Spline_Knots_ITL_Det94_21Jun22.pdf")
